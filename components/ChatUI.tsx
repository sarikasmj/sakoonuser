  ...
  useEffect(() => {
    ...
    const initZego = async () => {
      ...
      try {
        ...
        // We are using OneONoneCall mode for a chat-like experience.
        // This works but might be less efficient than using Zego's In-app Chat (ZIM) SDK
        // if only text chat functionality is needed.
        zp.joinRoom({
